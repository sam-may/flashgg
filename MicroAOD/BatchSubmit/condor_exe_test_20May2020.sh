...
# Untar
rm package.tar.gz
#wget http://gftp-2.t2.ucsd.edu:1094/store/user/smay/FCNC/tarballs/microAOD_package_test_20May2020.tar.gz
xrdcp root://redirector.t2.ucsd.edu//store/user/smay/FCNC/tarballs/microAOD_package_test_20May2020.tar.gz .
mv microAOD_package_test_20May2020.tar.gz package.tar.gz
