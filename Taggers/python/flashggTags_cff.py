...
flashggFCNCHadronicTag = cms.EDProducer("FlashggFCNCHadronicTagProducer",
                                       ...
                                       BoundariesHutNRB = cms.vdouble(0.892835, 0.953641, 0.978984, 0.9894),
                                       BoundariesHctNRB = cms.vdouble(0.953495, 0.955823, 0.986507, 0.9904),
                                       BoundariesHutSMH = cms.vdouble(0.425821, 0.622364, 0.631560, 0.854348),
                                       BoundariesHctSMH = cms.vdouble(0.001188, 0.511127, 0.754441, 0.884914),
                                       dRJetPhoLeadCut =  cms.double(0.4),
                                       dRJetPhoSubleadCut = cms.double(0.4),
                                       MuonEtaCut = cms.double(2.4),
                                       MuonPtCut = cms.double(5),
...
flashggFCNCLeptonicTag = cms.EDProducer("FlashggFCNCLeptonicTagProducer",
                                       ...
                                       MVAThresholdHutNRB = cms.vdouble(0.301167, 0.847050, 0.9296),
                                       MVAThresholdHctNRB = cms.vdouble(0.842787, 0.879531, 0.9173),
                                       MVAThresholdHutSMH = cms.vdouble(0.322078, 0.454406, 0.765012),
                                       MVAThresholdHctSMH = cms.vdouble(0.465847, 0.632898, 0.834137),
                                       PhoMVAThreshold = cms.double(-0.7),
                                       jetsNumberThreshold = cms.double(1.),
                                       bjetsNumberThreshold = cms.double(0.),
                                       jetPtThreshold = cms.double(25.),
