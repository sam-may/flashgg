              ...
              cms.EDProducer('FlashggJetSystematicProducer',
                             ...
                             SystMethods = cms.VPSet(cms.PSet( MethodName = cms.string("FlashggJetEnergyCorrector"),
                                                     ...
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               ...
                                                               bTagReshapeSystOption = cms.int32(2),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_hfstats1"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(3),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_hfstats2"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(4),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_cferr1"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(5),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_cferr2"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(6),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_hf"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(7),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_lfstats1"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(8),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_lfstats2"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
                                                               bTag = cms.string(str(bTagger)),
                                                               bTagCalibrationFile = cms.FileInPath(str(self.metaConditions['bTagSystematics']['bTagCalibrationFile_Reshape_'+ str(bTagger)])),
                                                               bTagReshapeSystOption = cms.int32(9),#For changing the source of uncertainty
                                                               Debug = cms.untracked.bool(False),
                                                               ApplyCentralValue = cms.bool(False)
                                                            ),
                                                     cms.PSet( MethodName = cms.string("FlashggJetBTagReshapeWeight"),
                                                               Label = cms.string("JetBTagReshapeWeight_jes"),
                                                               NSigmas = cms.vint32(-1,1),
                                                               OverallRange = cms.string("pt>25.0&&abs(eta)<" + str(eta)),
                                                               BinList = getattr(self, self.metaConditions['bTagSystematics']['bTagEffBins']),
                                                               #                                                          bTag = cms.string(flashggBTag),
