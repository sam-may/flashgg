...
# Untar
rm package.tar.gz
#wget http://gftp-2.t2.ucsd.edu:1094/store/user/smay/FCNC/tarballs/FIXME
xrdcp root://redirector.t2.ucsd.edu//store/user/smay/FCNC/tarballs/FIXME .
mv FIXME package.tar.gz
